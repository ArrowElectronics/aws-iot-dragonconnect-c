...
echo -e "################################################"
    ...
    echo -e "#### Access your $ARROW_APP_SEARCH_NEEDLE AWS Endpoint here: $AWS_ENDPOINT"
    echo -e "#### Access your $ARROW_APP_SEARCH_NEEDLE AWS API Gateway here: $AWS_API_GATEWAY"
