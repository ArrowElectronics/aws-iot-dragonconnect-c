...
var subjectSchema = require('model/led/update/response');

var config = require('./../../../config');

describe('the led update response model', function() {
  ...
  it('must not validate a response with additional properties', function(done) {
    ...
    var message = {
      thingId: 'invalidAdditionalProperties',
      active: true,
